...
//  const handleSave = (data, requiredFields,buttonClicked,setJsonData,setJsonfile,setButtonClicked) => {
//     console.log(data);
...
//       properties: json,
//     },buttonClicked,setJsonData,setJsonfile,setButtonClicked);
//   };

//   const handlecreatefile = (data,buttonClicked,setJsonData,setJsonfile,setButtonClicked) => {
//     console.log(data);
