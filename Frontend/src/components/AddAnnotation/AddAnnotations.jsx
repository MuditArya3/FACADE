...
const AddAnnotations = () => {
  ...
  useEffect(() => {
        ...
        {swaggerData &&
            ...
            setdescrip(swaggerData.paths[selectedApi][selectedMethod].description)
    ...
    {swaggerData &&
        ...
        selectedMethod && 
                ...
                setOperId(swaggerData.paths[selectedApi][selectedMethod].operationId)
                    console.log(operId);
}
      ...
      >
        ...
        >
          <Input
            ...
            onChange={(e) =>
              handleInputChange(e, setSwaggerData, setErrorMessage)
            }
          />
        </div>
        ...
        >
          <InputLabel id="table-select-label" sx={{ fontSize: "1.5rem" }}>
            Select Endpoint:
          </InputLabel>
          <Select
            ...
            >
              ...
              >
                ...
                <input
                  type="text"
                  value={serviceInput}
                  onChange={(e) => handleServiceInputChange(e, setServiceInput)}
              ...
              >
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleOperationInputChange(e, setOperationInput)
                  }
                  style={{ marginTop: "5px", padding: "5px" }}
                />
              </Box>
                    ...
                    {editRowIndex === index ? (
                      <>
                        ...
                        >
                          ...
                          <Button
                            onClick={(e) => handleEditCancel(setEditRowIndex)}
                          >
                            Cancel{" "}
                          </Button>
                        </TableCell>
                      ...
                      <>
                        ...
                        >
                          <Button
                            onClick={() => handleEdit(index, setEditRowIndex)}
                          >
                            <Edit />
                          </Button>
                          <Button
